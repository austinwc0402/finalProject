...
function myWindow() {
    // urlString = "popupWindow.html?" + "name=" + name + "&address=" + address
    let popup = window.open("popupWindow.html", "_blank", "height=500", "width=500", "left=100", "top=100", "resizable=yes", "scrollbars=yes",
    ...
    popup.onload = function() {
        ...
        popup.document.getElementById('objectives_pop').innerHTML = "Career Objectives";
        popup.document.getElementById('objectivesText').innerHTML = careerObj;

        // Personal information
        var personalInfo = document.getElementById('info').value;
        popup.document.getElementById('personalInfo').innerHTML = "Personal Information";
        ...
        popup.document.getElementById('eduBkg').innerHTML = "Educational Background";
        popup.document.getElementById('eduBkgText').innerHTML = eduBkg;

        // Employment experience
        popup.document.getElementById('employmentExperience').innerHTML = "Employment Experience";
